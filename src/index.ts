...
import { CallSetFirstTimeConfigChannel, OnFirstStartChannel } from './ipc/channels';
...
async function setupIpc() {
  ...
  ipcMain.handle(CallSetFirstTimeConfigChannel, (_, wowPath: string, startWoWAfterPatch: boolean) => {
    store.set('freedomWoWRootDir', wowPath);
    store.set('launchWoWAfterPatch', startWoWAfterPatch);
  });
